...
if (isset($_POST["sbm"])) {
    ...
    $day = $_POST["day"];
    $kip = $_POST["kip"];
    $query_check = "SELECT * from schedue where teacher_id = $teacher_id and day = $day and kip = $kip";
    $check_result = mysqli_query($conn, $query_check);
    $query_check2 = "SELECT * from schedue where class_id = $class_id and day = $day and kip = $kip";
    $check_result2 = mysqli_query($conn, $query_check2);
    if (mysqli_num_rows($check_result) == 0 && mysqli_num_rows($check_result2) == 0) {
