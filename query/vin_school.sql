...
ALTER TABLE `point_student`
  ...
  ADD KEY `student_id` (`point_student_id`);
...
ALTER TABLE `teacher`
  ...
  ADD KEY `FK_teacher_class` (`class_id`);
...
--
ALTER TABLE `point_student`
  ADD CONSTRAINT `point_student_ibfk_1` FOREIGN KEY (`semester_id`) REFERENCES `semester` (`semester_id`),
  ADD CONSTRAINT `point_student_ibfk_2` FOREIGN KEY (`point_student_id`) REFERENCES `student` (`student_id`);

--
-- Constraints for table `schedue`
--
ALTER TABLE `schedue`
  ADD CONSTRAINT `schedue_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`),
  ADD CONSTRAINT `schedue_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`),
  ADD CONSTRAINT `schedue_ibfk_3` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`);
...
--
ALTER TABLE `teacher`
  ADD CONSTRAINT `FK_teacher_class` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`);
COMMIT;
