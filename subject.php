<!-- Lấy toàn bộ class ra: SELECT * FROM -->
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div id="toolbar" class="btn-group">
            <a href="index.php?page_layout=add_subject" class="btn btn-success">
                        ...
                        <table 
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $total_rows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM subject"));
                                    ...
                                    $list_pages .= '<li class="page-item"><a class="page-link" href="index.php?page_layout=subject&page='.$page_next.'">&raquo;</a></li>';
