                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="point_student_id" class="form-control">
                                        ...
                                        ?>
                                            <option <?php if($row['student_id'] == $rowStd['point_student_id']){echo "selected";} ?> value=<?php echo $row["student_id"];?>><?php echo $row["student_name"];?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="point_semester_name" class="form-control">
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_array($query)){
                                        ?>
                                            <option <?php if($row['semester_name'] == $rowStd['semester_name']){echo "selected";} ?> value=<?php echo $row["semester_name"];?>><?php echo $row["semester_name"];?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
